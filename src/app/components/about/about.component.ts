...
export class AboutComponent  implements OnInit, AfterViewInit {
  ...
  updateEngagementChart(prefix: string) {
    ...
    const totalLikes = prefix === 'jawed' ? this.compte1TotalLikes : this.compte2TotalLikes;
    const totalComments = prefix === 'jawed' ? this.compte1TotalComments : this.compte2TotalComments;
  ...
  updateAverageChart(prefix: string) {
    ...
    const averageLikesPerPost = prefix === 'jawed' ? this.compte1AverageLikesPerPost : this.compte2AverageLikesPerPost;
    const averageCommentsPerPost = prefix === 'jawed' ? this.compte1AverageCommentsPerPost : this.compte2AverageCommentsPerPost;
